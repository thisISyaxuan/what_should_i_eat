...
const QA = () => {
    ...
    return (
        ...
        <Text style={styles.answer}>A：系統在登入且尋求您的同意之後，系統會抓取你的定位，所以需要稍等約 10 秒中的時間 ~ </Text>
        ...
        <Text style={styles.answer}>A：方法有二，一是在「我的精靈」頁面，每日提供一次簽到機會，可賺取 100 雞腿幣；二是透過記帳，每成功記帳一筆記錄，也可賺賺取 20 雞腿幣。</Text>
        ...
        <Text style={styles.answer}>A：在帳號設定中可點選「瀏覽紀錄」，便可以依序找到您瀏覽過的資聽，隨時找回您感興趣的餐廳。</Text>
