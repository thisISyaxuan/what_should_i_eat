...
class recommend(generics.GenericAPIView):
    def post(self, request, *args, **kwargs):
        ...
        if user.is_authenticated:
            ...
            DataFrameResult = recommender.main('recommend', user.id, updated_request['TimeFilter'], updated_request['MealFilter'], updated_request['LabelFilter'], updated_request['userPos'], updated_request['DistanceSort'], updated_request['RatingSort'])
