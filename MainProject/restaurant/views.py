...
class recommend(generics.GenericAPIView):
    def post(self, request, *args, **kwargs):
        ...
        if user.is_authenticated:
            user_id = user.id
            # uID, TimeFilter, MealFilter, LabelFilter, userPose, RatingSort
            rID_list = recommender.main(user_id, updated_request['TimeFilter'],  updated_request['MealFilter'], updated_request['LabelFilter'],  updated_request['userPos'],  updated_request['RatingSort'])
            print(rID_list)
            # result_dict = {}
